...
single_port_async_read_write_ram dut(
    .data(data),
...
initial begin
    $dumpfile("single_port_async_read_write_ram.vcd");
    $dumpvars(0,single_port_async_read_write_ram_tb);
end
