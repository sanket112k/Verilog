`timescale 1ns/1ps
module dual_port_ram_with_async_read_write_tb;
wire [7:0] data0;
...
dual_port_ram_with_async_read_write dut(
    .data0(data0),
...
initial begin
    $dumpfile("dual_port_ram_with_async_read_write.vcd");
    $dumpvars(0,dual_port_ram_with_async_read_write_tb);
end
