module seq_detect_1010_moore_overlap_tb;
reg clk, reset, in;
wire out;

seq_detect_1010_moore_overlap dut(clk, reset, in, out);
...
initial begin
    ...
    $dumpfile("seq_detect_1010_moore_overlap.vcd");
    $dumpvars(0,seq_detect_1010_moore_overlap_tb);
end
endmodule

/*
* OUTPUT
VCD info: dumpfile seq_detect_1010_moore_overlap.vcd opened for output.
