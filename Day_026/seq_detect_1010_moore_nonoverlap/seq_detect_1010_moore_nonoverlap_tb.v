module seq_detect_1010_moore_nonoverlap_tb;
reg clk, reset, in;
wire out;

seq_detect_1010_moore_nonoverlap dut(clk, reset, in, out);
...
initial begin
    ...
    $dumpfile("seq_detect_1010_moore_nonoverlap.vcd");
    $dumpvars(0,seq_detect_1010_moore_nonoverlap_tb);
end
endmodule

/*
* OUTPUT
VCD info: dumpfile seq_detect_1010_moore_nonoverlap.vcd opened for output.
...
seq_detect_1010_moore_nonoverlap_tb.v:28: $finish called at 270 (1s)
