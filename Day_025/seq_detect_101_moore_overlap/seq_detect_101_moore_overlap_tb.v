module seq_detect_101_moore_overlap_tb;
reg clk, reset, in;
wire out;

seq_detect_101_moore_overlap dut(clk, reset, in, out);
...
initial begin
    ...
    $dumpfile("seq_detect_101_moore_overlap.vcd");
    $dumpvars(0,seq_detect_101_moore_overlap_tb);
end
endmodule

/*
* OUTPUT
VCD info: dumpfile seq_detect_101_moore_overlap.vcd opened for output.
...
t=440 clk=0 reset=0 in=1 out=0
t=445 clk=1 reset=0 in=1 out=1
t=450 clk=0 reset=0 in=1 out=1
...
t=575 clk=1 reset=0 in=1 out=1
t=580 clk=0 reset=0 in=1 out=1
...
seq_detect_101_moore_overlap_tb.v:28: $finish called at 650 (1s)
t=650 clk=0 reset=0 in=1 out=0
*/ 
