module _4_bit_sync_up_counter_tb;
reg clk;
reg reset;
wire [3:0]count;

_4_bit_sync_up_counter dut(clk, reset, count);
...
initial begin
    ...
    $dumpfile("_4_bit_sync_up_counter.vcd");
    $dumpvars(0,_4_bit_sync_up_counter_tb);
end
endmodule

/*
* OUTPUT WAVEFORM LINK
* https://drive.google.com/file/d/1jFyiYesE-kgFRbq-muQF5jgtFVsjnKLX/view?usp=drive_link
* OUTPUT
VCD info: dumpfile _4_bit_sync_up_counter.vcd opened for output.
...
t=95 clk=1 reset=0 count=1010
t=100 clk=0 reset=1 count=1010
...
t=225 clk=1 reset=0 count=1010
t=230 clk=0 reset=0 count=1010
t=235 clk=1 reset=0 count=1011
t=240 clk=0 reset=0 count=1011
t=245 clk=1 reset=0 count=1100
t=250 clk=0 reset=0 count=1100
t=255 clk=1 reset=0 count=1101
t=260 clk=0 reset=0 count=1101
t=265 clk=1 reset=0 count=1110
t=270 clk=0 reset=0 count=1110
t=275 clk=1 reset=0 count=1111
t=280 clk=0 reset=0 count=1111
t=285 clk=1 reset=0 count=0000
t=290 clk=0 reset=0 count=0000
t=295 clk=1 reset=0 count=0001
t=300 clk=0 reset=0 count=0001
t=305 clk=1 reset=0 count=0010
t=310 clk=0 reset=0 count=0010
t=315 clk=1 reset=0 count=0011
t=320 clk=0 reset=0 count=0011
_4_bit_sync_up_counter_tb.v:24: $finish called at 325 (1s)
t=325 clk=1 reset=0 count=0100
*/ 
